...
Authorization: Bearer allotly_sk_...`}</CodeBlock>
  ...
  "error": {
    ...
    "code": 402
          ...
          <p className="text-sm text-muted-foreground mb-4">
            On success the response envelope contains <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">success: true</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">user_type</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">model_used</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">response_text</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">cost_usd_cents</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">cost.display</code> (already FX-converted and formatted in the org's currency), <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">budget</code> (<code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">remaining_usd_cents</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">total_usd_cents</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">display</code>), and <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">latency_ms</code>. On failure it returns <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">success: false</code> plus <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">user_type</code> and an <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">error</code> object with <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">code</code>, <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">message</code>, and <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">hint</code>. The <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">code</code> is one of six values —
            <code className="px-1 py-0.5 mx-1 rounded-md bg-muted text-xs font-mono">no_providers_active</code>,
            <code className="px-1 py-0.5 mx-1 rounded-md bg-muted text-xs font-mono">no_models_in_tier</code>,
            <code className="px-1 py-0.5 mx-1 rounded-md bg-muted text-xs font-mono">budget_exhausted</code>,
            <code className="px-1 py-0.5 mx-1 rounded-md bg-muted text-xs font-mono">rate_limited</code>,
            <code className="px-1 py-0.5 mx-1 rounded-md bg-muted text-xs font-mono">provider_error</code>, or
            <code className="px-1 py-0.5 mx-1 rounded-md bg-muted text-xs font-mono">unknown</code>
            — and the <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">hint</code> branches on the caller's <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">user_type</code> (<code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">team_admin</code> / <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">team_member</code> / <code className="px-1 py-0.5 rounded-md bg-muted text-xs font-mono">voucher_recipient</code>) so the recommended fix points to the right dashboard surface. Short-circuit paths (no providers, no models, pre-call budget exhaustion) still consume a rate-limit slot so the endpoint cannot be used to probe org state. Vouchers are auto-tested at redemption time using the same pipeline; the result is shown inline on the redemption page.
          </p>
